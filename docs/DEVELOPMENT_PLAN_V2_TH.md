...
งานเพิ่มเติมตามคำขอ — **เมนูวิธีใช้งานและคู่มือภาษาไทย** (`2.3.0-rc.1`): Done — เผยแพร่ 31 สิงหาคม 2026
ครอบคลุม 22 หัวข้อจาก source เดียว มีสารบัญ ดาวน์โหลด/พิมพ์ และอ่านได้เมื่อข้อมูลทีมโหลดไม่ได้
ติดตามผลตรวจที่ [USER_GUIDE_QA.md](USER_GUIDE_QA.md). ไม่ถือเป็นการปิด Phase 2 หรือ Phase 7 ส่วนที่ยังเหลือ

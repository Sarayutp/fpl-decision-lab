...
**Phase 7B เผยแพร่แล้วเมื่อ 31 สิงหาคม 2026:** รุ่น `2.2.0-rc.1`, build
`0bc7ec62cd99e14d`, Team ID `5105794`, snapshot `2026-08-31T03:37:31.897488+00:00`.
CI และ published smoke ผ่าน ดู [หลักฐานและข้อจำกัดของผลตรวจ](PHASE_7B_QA.md)

การซ้อม hosted restore ทำไว้ใน [Phase 6](PHASE_6_QA.md); checker รองรับ manifest รุ่นก่อน
และตรวจ artifact Phase 7A เดิมผ่าน โดยไม่ได้ deploy ย้อนรุ่นระหว่างการตรวจ Phase 7B

### ด่านก่อนและหลังเผยแพร่

1. CI ตรวจ Python 62/JS 44, contract, payload budget และ browser E2E 52 cases โดยไม่รับ flaky pass
